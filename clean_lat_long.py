...
I personally don't like the format for adding inputs as seen on lines 11-14 and 39-42 - but it does keep my directories to myself
'''
...
data = (data.pipe(get_features)
        .pipe(reorder_cols)
        .pipe(format_idx_drop_duplicates)
        .pipe(write_file))
print("File written to {}{}".format(file_path_out, file_name_out))
